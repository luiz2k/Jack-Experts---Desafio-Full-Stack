...
export class Init1724941889387 implements MigrationInterface {
    name = 'Init1724941889387'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "tasks" ("id" varchar PRIMARY KEY NOT NULL, "description" varchar(20) NOT NULL, "status" varchar CHECK( "status" IN ('pending','completed') ) NOT NULL DEFAULT ('pending'), "created_at" date NOT NULL DEFAULT (CURRENT_TIMESTAMP), "user_id" varchar)`);
        ...
        await queryRunner.query(`CREATE TABLE "sessions" ("id" varchar PRIMARY KEY NOT NULL, "token" varchar NOT NULL, "created_at" date NOT NULL, "expires_at" date NOT NULL, "is_valid" boolean NOT NULL DEFAULT (1), "user_id" varchar)`);
        await queryRunner.query(`CREATE TABLE "temporary_tasks" ("id" varchar PRIMARY KEY NOT NULL, "description" varchar(20) NOT NULL, "status" varchar CHECK( "status" IN ('pending','completed') ) NOT NULL DEFAULT ('pending'), "created_at" date NOT NULL DEFAULT (CURRENT_TIMESTAMP), "user_id" varchar, CONSTRAINT "FK_db55af84c226af9dce09487b61b" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_sessions" ("id" varchar PRIMARY KEY NOT NULL, "token" varchar NOT NULL, "created_at" date NOT NULL, "expires_at" date NOT NULL, "is_valid" boolean NOT NULL DEFAULT (1), "user_id" varchar, CONSTRAINT "FK_085d540d9f418cfbdc7bd55bb19" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
